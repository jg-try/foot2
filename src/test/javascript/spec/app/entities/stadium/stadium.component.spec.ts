...
import { StadiumComponent } from 'app/entities/stadium/stadium.component';
    ...
    describe('Stadium Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(StadiumComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.stadiums[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
