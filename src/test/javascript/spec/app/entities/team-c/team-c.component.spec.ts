...
import { TeamCComponent } from 'app/entities/team-c/team-c.component';
import { TeamCService } from 'app/entities/team-c/team-c.service';
import { TeamC } from 'app/shared/model/team-c.model';

describe('Component Tests', () => {
    describe('TeamC Management Component', () => {
        let comp: TeamCComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TeamCComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.teamCS[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
