...
public class MatchResourceIntTest {
    ...
    private static final Integer DEFAULT_SCORE_C = 1;
    private static final Integer UPDATED_SCORE_C = 2;

    private static final Integer DEFAULT_SCORE_S = 1;
    private static final Integer UPDATED_SCORE_S = 2;
    ...
    public static Match createEntity(EntityManager em) {
        Match match = new Match()
            .date(DEFAULT_DATE)
            .scoreC(DEFAULT_SCORE_C)
            .scoreS(DEFAULT_SCORE_S);
        return match;
    }
    ...
    public void createMatch() throws Exception {
        ...
        assertThat(testMatch.getScoreC()).isEqualTo(DEFAULT_SCORE_C);
        assertThat(testMatch.getScoreS()).isEqualTo(DEFAULT_SCORE_S);
    }
    ...
    public void getAllMatches() throws Exception {
        ...
        restMatchMockMvc.perform(get("/api/matches?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].scoreC").value(hasItem(DEFAULT_SCORE_C)))
            .andExpect(jsonPath("$.[*].scoreS").value(hasItem(DEFAULT_SCORE_S)));
    }
    ...
    public void getMatch() throws Exception {
        ...
        restMatchMockMvc.perform(get("/api/matches/{id}", match.getId()))
            ...
            .andExpect(jsonPath("$.scoreC").value(DEFAULT_SCORE_C))
            .andExpect(jsonPath("$.scoreS").value(DEFAULT_SCORE_S));
    }
    ...
    public void updateMatch() throws Exception {
        ...
        updatedMatch
            .date(UPDATED_DATE)
            .scoreC(UPDATED_SCORE_C)
            .scoreS(UPDATED_SCORE_S);
        ...
        assertThat(testMatch.getScoreC()).isEqualTo(UPDATED_SCORE_C);
        assertThat(testMatch.getScoreS()).isEqualTo(UPDATED_SCORE_S);
    }
